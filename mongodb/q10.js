//Replication -
//We create three servers which are in different countries as primary and two secondary
//In primary we can write read anything but in secondary, we can only read
//It is helpful when primary server gets down in some disaster so from the other two servers
//any one becomes primary because all have the same files 
//updation happens immediately in all servers

// create a folder mongo-replica and sub folders as data1, data2, data3

//SHARDING - to reduce the load on one server.
//we create rs1 and rs2. So after a threshold limit, mydatabase's collection - customers data starts distributing the data into rs2
